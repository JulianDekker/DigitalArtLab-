...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'digitalartlabbundle.registration_listener' => 'getDigitalartlabbundle_RegistrationListenerService',
     ...
     * This method always returns the same instance of the service.
     *
     * @return \DigitalArtLabBundle\Form\ProfileFormType A DigitalArtLabBundle\Form\ProfileFormType instance.
     */
    protected function getApp_Form_ProfileService()
    {
        return $this->services['app.form.profile'] = new \DigitalArtLabBundle\Form\ProfileFormType();
    }
     ...
     * This method always returns the same instance of the service.
     *
     * @return \DigitalArtLabBundle\Form\RegistrationType A DigitalArtLabBundle\Form\RegistrationType instance.
     */
    protected function getApp_Form_RegistrationService()
    {
        return $this->services['app.form.registration'] = new \DigitalArtLabBundle\Form\RegistrationType();
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DigitalArtLabBundle', ($this->targetDirs[2].'/Resources/DigitalArtLabBundle/views'), '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'DigitalArtLabBundle', ($this->targetDirs[3].'\\src\\DigitalArtLabBundle/Resources/views'), '/\\.[^.]+\\.twig$/'))), 'twig');
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('digitalartlabbundle.registration_listener', 'DigitalArtLabBundle\\Eventlistener\\RegistrationListener');
    ...
    /**
     * Gets the 'digitalartlabbundle.registration_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DigitalArtLabBundle\Eventlistener\RegistrationListener A DigitalArtLabBundle\Eventlistener\RegistrationListener instance.
     */
    protected function getDigitalartlabbundle_RegistrationListenerService()
    {
        return $this->services['digitalartlabbundle.registration_listener'] = new \DigitalArtLabBundle\Eventlistener\RegistrationListener();
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'digitalartlab', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => ($this->targetDirs[3].'\\src\\DigitalArtLabBundle\\Entity'))), 'DigitalArtLabBundle\\Entity');
        ...
        $b->setEntityNamespaces(array('DigitalArtLabBundle' => 'DigitalArtLabBundle\\Entity'));
        ...
        $b->addCustomStringFunction('ascii', 'DoctrineExtensions\\Query\\Mysql\\Ascii');
        $b->addCustomStringFunction('binary', 'DoctrineExtensions\\Query\\Mysql\\Binary');
        $b->addCustomStringFunction('char_length', 'DoctrineExtensions\\Query\\Mysql\\CharLength');
        ...
        $b->addCustomStringFunction('crc32', 'DoctrineExtensions\\Query\\Mysql\\Crc32');
        ...
        $b->addCustomStringFunction('find_in_set', 'DoctrineExtensions\\Query\\Mysql\\FindInSet');
        $b->addCustomStringFunction('group_concat', 'DoctrineExtensions\\Query\\Mysql\\GroupConcat');
        ...
        $b->addCustomStringFunction('least', 'DoctrineExtensions\\Query\\Mysql\\Least');
        $b->addCustomStringFunction('match_against', 'DoctrineExtensions\\Query\\Mysql\\MatchAgainst');
        ...
        $b->addCustomStringFunction('replace', 'DoctrineExtensions\\Query\\Mysql\\Replace');
        ...
        $b->addCustomStringFunction('soundex', 'DoctrineExtensions\\Query\\Mysql\\Soundex');
        $b->addCustomStringFunction('substring_index', 'DoctrineExtensions\\Query\\Mysql\\SubstringIndex');
        $b->addCustomStringFunction('uuid_short', 'DoctrineExtensions\\Query\\Mysql\\UuidShort');
        ...
        $b->addCustomNumericFunction('hour', 'DoctrineExtensions\\Query\\Mysql\\Hour');
        ...
        $b->addCustomDatetimeFunction('datesub', 'DoctrineExtensions\\Query\\Mysql\\DateSub');
        ...
        $b->addCustomDatetimeFunction('from_unixtime', 'DoctrineExtensions\\Query\\Mysql\\FromUnixtime');
        $b->addCustomDatetimeFunction('last_day', 'DoctrineExtensions\\Query\\Mysql\\LastDay');
        $b->addCustomDatetimeFunction('minute', 'DoctrineExtensions\\Query\\Mysql\\Minute');
        $b->addCustomDatetimeFunction('second', 'DoctrineExtensions\\Query\\Mysql\\Second');
        $b->addCustomDatetimeFunction('strtodate', 'DoctrineExtensions\\Query\\Mysql\\StrToDate');
        $b->addCustomDatetimeFunction('time', 'DoctrineExtensions\\Query\\Mysql\\Time');
        $b->addCustomDatetimeFunction('timestampadd', 'DoctrineExtensions\\Query\\Mysql\\TimestampAdd');
        ...
        $b->addCustomDatetimeFunction('weekday', 'DoctrineExtensions\\Query\\Mysql\\WeekDay');
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_021cf8f30a96b4b39b3643f9b4bad300233e003ada7ef78748bcbda14eb752e6');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('DigitalArtLabBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.factory'] = new \FOS\UserBundle\Form\Factory\FormFactory($this->get('form.factory'), 'fos_user_profile_form', 'profileform', array(0 => 'Profile', 1 => 'Default'));
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('DigitalArtLabBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('DigitalArtLabBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('DigitalArtLabBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'DigitalArtLabBundle\\Entity\\User');
    }
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'DigitalArtLabBundle'), new \Symfony\Bundle\AsseticBundle\DefaultValueSupplier($this)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'\\src\\DigitalArtLabBundle/Resources/views'), 'DigitalArtLab');
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'DigitalArtLabBundle' => 'DigitalArtLabBundle\\DigitalArtLabBundle',
            ...
            'assetic.sass.bin' => 'C:\\Ruby21-x64\\bin\\sass.BAT',
            ...
            'fos_user.model.user.class' => 'DigitalArtLabBundle\\Entity\\User',
            'fos_user.profile.form.type' => 'profileform',
